...
pub fn main() -> i32 {
    ...
    vdso::spawn(move || server_read(read_end, 333), 0, getpid() as usize + 1, basic::CoroutineKind::UserNorm);
    vdso::spawn(move || client_write(write_end, 333), 1, getpid() as usize + 1, basic::CoroutineKind::UserNorm);
    0
}
